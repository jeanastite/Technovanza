# Note this program may take some time to generate output, wait patiently.
...
image = cv2.imread(r"Technovanza\task_2\real_world_soln\images\warehouse-top view_1.jpg", cv2.IMREAD_GRAYSCALE)
